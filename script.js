...
function trianglecalc(a,b,type,side,rarity,level){
  ...
  if (type=="triangleexploder" && (use4 || !cooldown) && !placed[a-1][b-1]){
    if (rarity=="common"){
      if (matter>=6 || !cost){
        if (cost) matter-=6;
        new triangleexploder(a,b,side,1000+level*30,2,3,3);
    ...
    if (rarity=="uncommon"){
      if (matter>=6 || !cost){
        if (cost) matter-=6;
        new triangleexploder(a,b,side,1200+level*35,1.8,3,3);
    ...
    if (rarity=="rare"){
      if (matter>=5 || !cost){
        if (cost) matter-=5;
        new triangleexploder(a,b,side,1425+level*40,1.6,3,3);
    ...
    if (rarity=="epic"){
      if (matter>=5 || !cost){
        if (cost) matter-=5;
        new triangleexploder(a,b,side,1675+level*45,1.4,3,5);
    ...
    if (rarity=="super"){
      if (matter>=4 || !cost){
        if (cost) matter-=4;
        new triangleexploder(a,b,side,1950+level*50,1.2,3,5);
    ...
    if (rarity=="legendary"){
      if (matter>=4 || !cost){
        if (cost) matter-=4;
        new triangleexploder(a,b,side,2250+level*55,1,5,5);
    ...
    if (rarity=="mythical"){
      if (matter>=3 || !cost){
        if (cost) matter-=3;
        new triangleexploder(a,b,side,2575+level*65,0.7,5,5);
    ...
    if (rarity=="ultra"){
      if (matter>=3 || !cost){
        if (cost) matter-=3;
        new triangleexploder(a,b,side,2925+level*75,0.4,5,7);
    ...
    if (rarity=="transcendent"){
      if (matter>=2 || !cost){
        if (cost) matter-=2;
        new triangleexploder(a,b,side,3300+level*90,0.1,5,7);
