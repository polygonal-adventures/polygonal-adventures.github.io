...
function play(a,b){
  if (menu==1) new movingtriangle(a,b,1,2,20,20)
  else if (menu==2) new blocktriangle(a,b,1,20)
  else if (menu==3) new triangle(a,b,1,10,20,2)
  else if (menu==4) new explodetriangle(a,b,2,100,0.5,10,100,100)
  else if (menu==5) new triangle(a,b,2,10,20,2)
}
var side1=[]
var side2=[]
var side1m=[]
